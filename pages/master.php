            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                for (let i = 0; i < response.data.length; i++) {
                  ...
                  for (let i5 = 0; i5 < response.data[i].sinonim.length; i5++) {
                    arrSinonim.push(' ' + response.data[i].sinonim[i5].sinonim)
                  }
        ...
        $.ajax({
          ...
          success: async function(response) {
            ...
            if (totalPages < 3) {
              // loop biasa
              if (page == 2) {
                $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/master?page=1">Previous</a> </li>')
              } else {
              ...
              for (let i_pages = 1; i_pages < totalPages+1; i_pages++) {
                if (i_pages == page) {
                  $('#pagination').append('<li class="page-item active"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+i_pages+'">'+i_pages.toLocaleString().replace(',','.')+'</a> </li>');
                } else {
                  $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+i_pages+'">'+i_pages.toLocaleString().replace(',','.')+'</a> </li>');
                }
              }
              ...
              if (page == 2) {
                ...
                $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
              }
              ...
              console.log('total page : '+totalPages);
                ...
                // alert(page3 )
              if (page2 >= totalPages) {
                $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+page1+'">Previous</a> </li>')
              ...
              if (page2 >= totalPages) {
                ...
                $('#pagination').append('<li class="page-item disabled"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
                page1 = 1
                page3 = Number(parseInt(page)+3)
              } else {
                $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/master?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
            ...
            for (let i = 0; i < response.data.length; i++) {
              ...
              $('#content').append('<tr> <td>'+response.data[i].kata_asli+'</td> <td>'+response.data[i].kata_dasar[1]+'</td> <td>'+arrKategori+'</td> <td>'+response.data[i].sinonim+'</td> <td>'+arrImbuhan+'</td> <td>'+arrAkhiran+'</td> <td>'+arrKataganti+'</td> <td>'+arrBahasa+'</td> <td>'+arrNegara+'</td> <td>'+arrProvinsi+'</td> <td>'+arrKabupaten+'</td> <td>'+arrKecamatan+'</td> <td>'+arrDesa+'</td><td>'+response.data[i].username+'</td><td>'+response.data[i].datetime+'</td> <td> <button type="button" class="btn waves-effect waves-light btn-success edit" data-toggle="modal" data-target="#exampleModal" id="'+response.data[i]._id+'"><i class="ti-pencil"></i></button> <button type="button" class="btn waves-effect waves-light btn-danger hapus" id="'+response.data[i]._id+'"><i class="ti-trash"></i></button></td> </tr>')
