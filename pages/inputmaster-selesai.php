...
<script>
  $(document).ready(function () {
    ...
    $(document).on('click','.statusopen',function(){
        var id = $(this).attr("id");
        swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
              url: '<?= $link_api3001 ?>clean2/balik/'+id+'/'+localStorage.getItem('id'),
              type: "PUT",
              dataType: "JSON",
              success: function(response) {
    ...
    function getData(){
      ...
      var url;
      if (page != null) {
        url = '<?= $link_api3001 ?>clean2/sudah?page='+page
      } else {
        url = '<?= $link_api3001 ?>clean2/sudah?page=1'
        page = 1
      }
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (totalPages < 3) {
            // loop biasa
            if (page == 2) {
              $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page=1">Previous</a> </li>')
            } else {
            ...
            for (let i_pages = 1; i_pages < totalPages+1; i_pages++) {
              if (i_pages == page) {
                $('#pagination').append('<li class="page-item active"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+i_pages+'">'+i_pages.toLocaleString().replace(',','.')+'</a> </li>');
              } else {
                $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+i_pages+'">'+i_pages.toLocaleString().replace(',','.')+'</a> </li>');
              }
            }
            ...
            if (page == 2) {
              ...
              $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
            }
            ...
            console.log('total page : '+totalPages);
              ...
              // alert(page3 )
            if (page2 >= totalPages) {
              $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+page1+'">Previous</a> </li>')
            ...
            if (page2 >= totalPages) {
              ...
              $('#pagination').append('<li class="page-item disabled"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
              page1 = 1
              page3 = Number(parseInt(page)+3)
            } else {
              $('#pagination').append('<li class="page-item"> <a class="page-link" href="<?= $actual_link ?>pages/inputmaster-selesai?page='+Number(parseInt(page)+1)+'">Next</a> </li>')
          ...
          response.data.map(function (item, index) {
            ...
            $.ajax({
              ...
              success: function (result) {
                ...
                statuse = '<span class="badge badge-danger statusopen" data-toggle="modal" style="cursor:pointer;" id="'+item._id+'">Open</span>'
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Input Master Selesai</h4>
                <div class="mt-4 activity">
